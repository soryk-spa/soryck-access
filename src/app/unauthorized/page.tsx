    ...
    switch (requiredRole) {
      case "organizer":
        return {
          ...
          message:
            "Esta página está disponible solo para organizadores de eventos y administradores.",
          suggestion:
            "Si deseas convertirte en organizador, contacta a nuestro equipo.",
        };
      case "admin":
        return {
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mt-8 p-4 bg-muted rounded-lg">
          <p className="text-sm text-muted-foreground">
            <strong>¿Necesitas ser organizador?</strong>
            <br />
            Los organizadores pueden crear y gestionar eventos. Contacta a
            nuestro equipo para solicitar permisos de organizador.
          </p>
        </div>
      </div>
    </div>
