            ...
            <div className="relative h-80 lg:h-96">
              ...
              <div className="absolute top-6 left-6 bg-white/95 backdrop-blur rounded-xl p-4 shadow-xl">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#0053CC] mb-1">{startDate.day}</div>
                  <div className="text-sm text-muted-foreground uppercase font-medium">{startDate.month}</div>
              ...
              <div className="absolute top-6 right-6 flex flex-col gap-2">
                <Badge variant="secondary" className="bg-white/90 backdrop-blur text-[#0053CC] font-medium">
                  {event.category.name}
                </Badge>
                {!event.isPublished && (
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-2 bg-black/30 backdrop-blur rounded-full px-3 py-1">
                    ...
                    <span className="text-sm truncate max-w-48">{event.location}</span>
                  </div>
                ...
                {canEdit && (
                  <div className="flex gap-2">
                    <Button asChild size="sm" className="bg-gradient-to-r from-[#FDBD00] to-[#FE4F00] hover:from-[#FDBD00]/90 hover:to-[#FE4F00]/90">
                ...
                {event.description ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground italic">
                      El organizador no ha proporcionado una descripción para este evento.
                    </p>
                  </div>
                )}
              </CardContent>
              ...
              <CardContent>
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-[#01CBFE]/10 to-[#0053CC]/10 rounded-xl">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-lg text-[#0053CC]">{getOrganizerName()}</h3>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-gradient-to-br from-[#01CBFE]/10 to-[#0053CC]/10 rounded-xl">
                    ...
                    <div className="text-2xl font-bold text-[#0053CC]">{event._count.tickets}</div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-[#FDBD00]/10 to-[#FE4F00]/10 rounded-xl">
                    ...
                    <div className="text-2xl font-bold text-[#FE4F00]">{availability.available}</div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-[#CC66CC]/10 to-[#FE4F00]/10 rounded-xl">
                    ...
                    <div className="text-2xl font-bold text-[#CC66CC]">{event._count.orders}</div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-[#FE4F00]/10 to-[#FDBD00]/10 rounded-xl">
                    ...
                    <div className="text-2xl font-bold text-[#FDBD00]">{Math.round((event._count.tickets / event.capacity) * 100)}%</div>
                ...
                <div className="mt-6">
                  ...
                  <div className="w-full bg-muted rounded-full h-3">
                    <div 
                      ...
                      style={{ width: `${Math.min((event._count.tickets / event.capacity) * 100, 100)}%` }}
                    />
                  </div>
                </div>
              </CardContent>
              ...
              <Card className="border-2 border-green-200 bg-green-50 dark:bg-green-950 shadow-lg">
                ...
                <CardContent>
                  <div className="text-center space-y-4">
                    <div className="text-3xl font-bold text-green-600">{userTicketsCount}</div>
                    <p className="text-green-700 dark:text-green-300">
                      Ticket{userTicketsCount > 1 ? 's' : ''} confirmado{userTicketsCount > 1 ? 's' : ''}
                    </p>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-start justify-between py-2 border-b border-muted">
                    ...
                    <span className="font-medium text-right">{startDate.full}</span>
                  </div>
                  ...
                  {endDate && (
                    <div className="flex items-start justify-between py-2 border-b border-muted">
                      ...
                      <span className="font-medium text-right">{endDate.full}</span>
                    </div>
                  )}
                  ...
                  <div className="flex items-start justify-between py-2 border-b border-muted">
                    ...
                    <span className="font-medium text-right max-w-48">{event.location}</span>
                  </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 text-orange-800 dark:text-orange-200">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1">Este evento ya ha terminado.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-2 text-yellow-800 dark:text-yellow-200">
                    ...
                    <div>
                      ...
                      <p className="text-sm mt-1">Este evento aún no está disponible públicamente.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
